h1. What is SlideshowFX ? !https://travis-ci.org/twasyl/SlideshowFX.svg!:https://travis-ci.org/twasyl/SlideshowFX
...
* A JDK 8 update 51 ;
* The @JAVA_HOME@ system variable set to point to you JDK 8 update 51 installation.

p. Then in order to build the application:

* Open a command line in the repository folder ;
* Execute the command @gradlew packageSlideshowFX@ and wait for it to finish successfully ;
