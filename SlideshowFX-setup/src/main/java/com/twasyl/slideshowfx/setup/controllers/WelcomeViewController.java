...
/**
 * Controller for the {WelcomeView.xml} file.
 *
...
public class WelcomeViewController implements Initializable {
     ...
     */
    public WelcomeViewController setApplicationName(final String applicationName) {
     ...
     * @return This instance of the controller.
     */
    public WelcomeViewController setApplicationVersion(final String applicationVersion) {
