...
- *bundle* provided for all plugins and to create the package for the plugin ;
- *installPlugin* provided for all plugins and allowing to deploy the plugin directly to the folder : `~/.SlideshowFX/plugins` ;
- *uninstallPlugin* provided for all plugins and allowing to deploy uninstall the plugin directly from the folder : `~/.SlideshowFX/plugins` ;
- *uninstallAllVersionsPlugin* provided for all plugins and allowing to deploy uninstall all versions of the plugin directly from the folder : `~/.SlideshowFX/plugins` ;
