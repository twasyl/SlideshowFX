...
| org.eclipse.mylyn.wikitext.core | 2.2.0.N20140702-2138 | Library used for textile support
...
**** *template-expression* : the name of the template token. It is the freemarker token without the dollar sign.
...
==== Valid freemarker tokens

The following freemarker tokens are available for SlideshowFX:
